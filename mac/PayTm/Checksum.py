...
def __encode__(to_encode, iv, key):
    ...
    # Encrypt
    c = AES.new(key.encode('utf-8'), AES.MODE_CBC, iv.encode('utf-8'))#aes jofunction hai usko utf-8 encoded data chahiye rehti hai
    #toh jaha jaha use koiya hai waha sab jagah humein use .encode use karna hai 
